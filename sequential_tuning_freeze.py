...
result_filename = f"./results/evaluation_results_epoch{args.epochs}_batchsize{args.batch_size}_lr{args.learning_rate}_freeze.jsonl"
if args.eval_on_train:
    result_filename = f"./results2//evaluation_results_epoch{args.epochs}_batchsize{args.batch_size}_lr{args.learning_rate}_freeze.jsonl"
